 ...
 */
final class RevisionRendererImpl implements RevisionRenderer {

  @Override
  public XmlElement renderRevision(BasePageEntry<?> entry) {
    ...
    historyLink.addXml("Version " + RendererUtils.getRevisionElement(entry));
